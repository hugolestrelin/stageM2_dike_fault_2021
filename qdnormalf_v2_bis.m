...
while t<par.tfinal
    ...
    %sigm.n=sigm.n+dsigm.n/(param.rho*param.g*param.z)*b*evoldyke(t,par.nbd,par.tdike+1/365*year*param.vp/param.dc)*dt*param.dc/param.vp;
    %sigm.t=sigm.t+dsigm.t/(param.rho*param.g*param.z)*b*evoldyke(t,par.nbd,par.tdike+1/365*year*param.vp/param.dc)*dt*param.dc/param.vp;
